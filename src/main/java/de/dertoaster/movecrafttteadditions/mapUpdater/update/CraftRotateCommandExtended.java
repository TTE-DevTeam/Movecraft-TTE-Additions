package de.dertoaster.movecrafttteadditions.mapUpdater.update;
...
public class CraftRotateCommandExtended extends UpdateCommand {
    ...
    public CraftRotateCommandExtended(@NotNull final Craft craft, @NotNull final MovecraftLocation originLocation, @NotNull final MovecraftRotation rotation, @NotNull final Axis axis) {
        this.craft = craft;
    ...
    public void doUpdate() {
        ...
        if (!passthroughBlocks.isEmpty()) {
            ...
            for (MovecraftLocation movecraftLocation : craft.getHitBox()) {
                originalLocations.add(MathUtil.rotateVec(counterRotation, this.axis, movecraftLocation.subtract(originLocation)).add(originLocation));
            }
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof CraftRotateCommandExtended)) {
            return false;
        }
        CraftRotateCommandExtended other = (CraftRotateCommandExtended) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(craft, rotation, axis, originLocation);
    }
