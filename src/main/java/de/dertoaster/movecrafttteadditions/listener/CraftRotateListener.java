...
public class CraftRotateListener implements Listener {
    ...
    public void onCraftRotate(final CraftRotateEvent event) {
        ...
        final String sound = type.getStringProperty(TTEAdditionsCraftTypeProperties.SOUND_ON_ROTATION);
        ...
        final Location position = event.getOriginPoint().toBukkit(world);
